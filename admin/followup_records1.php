<?php
// followup_records1.php - 带看统计（自定义列表视图），与 followup_records.php 功能同源；独立接口路径与 localStorage 键，互不干扰
session_start();
...
<div id="app" class="flex h-screen overflow-hidden">
    ...
    createApp({
        setup() {
            ...
            // 页面标题
            const pageTitle = computed(() => '带看统计表（自定义列）');
            ...
            const loadRecords = async () => {
                try {
                    ...
                    const res = await fetch('followup_records1.php?' + params.toString());
            ...
            const loadProjects = async () => {
                const res = await fetch('followup_records1.php?action=get_projects');
            ...
            const exportExcel = () => {
                ...
                window.location.href = 'followup_records1.php?' + params.toString();
            };
            ...
            const saveSummary = async () => {
                ...
                const res = await fetch('followup_records1.php?action=' + action, {
                    method: 'POST',
            ...
            const deleteSummary = async (id) => {
                ...
                const res = await fetch('followup_records1.php?action=delete_summary_option', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
            ...
            const saveVisibleColumns = () => {
                try {
                    localStorage.setItem('followup_records1_visible_columns', JSON.stringify(visibleColumns.value));
                } catch (e) {}
            };
            const loadVisibleColumns = () => {
                try {
                    const raw = localStorage.getItem('followup_records1_visible_columns');
                    if (!raw) return;
            ...
            const saveColumnOrder = () => {
                try {
                    localStorage.setItem('followup_records1_column_order', JSON.stringify(columnOrder.value));
                } catch (e) {}
            };
            ...
            const loadColumnOrder = () => {
                try {
                    const raw = localStorage.getItem('followup_records1_column_order');
                    if (!raw) {
            ...
            const saveFollowup = async () => {
                ...
                const res = await fetch('followup_records1.php?action=save_followup_record', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
            ...
            const deleteFollowup = async (id) => {
                ...
                const res = await fetch('followup_records1.php?action=delete_followup_record', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ id })
                });
